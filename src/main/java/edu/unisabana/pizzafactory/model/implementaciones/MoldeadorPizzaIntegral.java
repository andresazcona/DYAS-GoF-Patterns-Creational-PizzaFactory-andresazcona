...
/**
 * Implementación de la interfaz {@link Moldeador} para pizzas integrales.
 * Esta clase define el proceso específico de moldeado para pizzas integrales.
 *
 * @author andresazcona
 */
public class MoldeadorPizzaIntegral implements Moldeador {
    ...
    /**
     * Método que ejecuta el proceso de moldeado para una pizza pequeña de masa integral.
    ...
    /**
     * Método que ejecuta el proceso de moldeado para una pizza mediana de masa integral.
